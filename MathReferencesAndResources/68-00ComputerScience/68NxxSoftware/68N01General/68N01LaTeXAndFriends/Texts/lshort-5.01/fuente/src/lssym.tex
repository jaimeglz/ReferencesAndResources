...
Los siguientes cuadros muestran todos los símbolos normalmente
accesibles desde \emph{modo mates}.  

%
% Conditional Text in case the AMS Fonts are installed
%
Para usar los símbolos listados en los
  cuadros~\ref{AMSD}-\ref{AMSNBR},\footnote{Estos cuadros provienen de
  \texttt{symbols.tex} de David~Carlisle y fueron cambiando mucho según
  las sugerencias de Josef~Tkadlec.} debe cargarse el paquete
\pai{amssymb} en el preámbulo del documento y las \fontsnomo{}
de la AMS deben estar instaladas en el sistema.  Si el paquete y las
  \fontsnomo{} AMS no están instaladas en su sistema, mire en
\CTANref|macros/latex/required/amslatex|.  Una lista de símbolos aun más completa
...
\bigskip
Puede negar los símbolos siguientes prefijándolos con la orden \ci{not}.
\begin{symbols}{*3{cl}}
 \X{<}           & \X{>}           & \X{=}          \\
...
\begin{table}[!tbp]
\caption{Símbolos AMS griegos y hebreos.}
\begin{symbols}{*5{cl}}
